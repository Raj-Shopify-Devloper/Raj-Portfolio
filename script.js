...
$(document).ready(function(){
    ...
    function typeTextFunc(typeElement, texts, typingSpeed, delayBeforeClear, delayBeforeNext) {
        let index = -1;
        let current = 0;
    ...
    typeTextFunc(typeElement, ["Front end developer ", "Creative-attractive, and mastery ", "Shopify Expert ", "2 Year+ Experience "], 150, 1000, 500);
    ...
    typeEffect(typingElement1, ["Front end developer ", "Shopify Expert ", "Technician ", "2 Year+ Experience "], 150, 75, true);
